...
def apiOverview(request):
    api_urls = {
        ...
        'Rooms Remove CR'                   : 'api/v1/rooms/remove/<str:room_pk>/class_representative/<str:username>/',
        'Rooms Remove Student'              : 'api/v1/rooms/remove/<str:room_pk>/student/<str:username>/',
        'Rooms Remove Teacher'              : 'api/v1/rooms/remove/<str:room_pk>/teacher/<str:username>/',
